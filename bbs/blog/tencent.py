...
def tencent_blog(request):
    if request.method == "POST":
        ...
        if "您的页面暂时无法找到" in html:
            ...
            blog_list = [{'href': 'qianmo2478', 'title': '浅沫'}, {'href': 'shouji136454071129', 'title': '李鑫'}, {'href': 'chensili8759', 'title': '陈思利'}, {'href': 'yincheng5428', 'title': '殷程'}, {'href': 'mayiren2712', 'title': '马伊人'}, {'href': 'tantejie6271', 'title': '忐忑姐'}]
            ret["msg"] = blog_list
            return JsonResponse(ret)
