...
class ClassList(models.Model):
    ...
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',limit_choices_to={"depart":1002},on_delete=models.CASCADE)
...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultanter',limit_choices_to={'depart_id': 1001},on_delete=models.CASCADE)
